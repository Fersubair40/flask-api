...
from app.api.middlewares import login_required
...
def json_response(payload, status=200):
    return (json_response(payload), status, {'content-type': 'application/json'})
